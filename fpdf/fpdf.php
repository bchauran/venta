...
/*function SetTitle($organismo, $proyecto, $unidad, $presupuesto, $isUTF8=false)
{
	//Title of document
	if($isUTF8)
		$organismo=$this->_UTF8toUTF16($organismo);
		$proyecto=$this->_UTF8toUTF16($proyecto);
		$unidad=$this->_UTF8toUTF16($unidad);
		$presupuesto=$this->_UTF8toUTF16($presupuesto);
